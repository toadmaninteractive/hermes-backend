defmodule Repo.Seeds do
  ...
  def seed_settings() do
    [
      %{name: "personnel_session_duration", type: :int, value: "31536000"},
    ] |> Enum.map(& Repo.Setting.insert(&1))
    :ok
  rescue
  ...
  def seed_countries() do
    ...
    ] |> Enum.map(& Repo.Country.insert(&1))
    :ok
  rescue
    Ecto.ConstraintError -> {:error, :eexists}
  after
  ...
  def seed_roles() do
    [
      %{id:  1, code: "00106", title: "Artist Intermediate"},
      %{id:  2, code: "00107", title: "Artist Junior"},
      %{id:  3, code: "00108", title: "Artist Senior"},
      %{id:  4, code: "00109", title: "Designer Intermediate"},
      %{id:  5, code: "00110", title: "Designer Junior"},
      %{id:  6, code: "00111", title: "Designer Senior"},
      %{id:  7, code: "00112", title: "Production Intermediate"},
      %{id:  8, code: "00113", title: "Production Junior"},
      %{id:  9, code: "00114", title: "Production Senior"},
      %{id: 10, code: "00115", title: "Programmer Intermediate"},
      %{id: 11, code: "00116", title: "Programmer Junior"},
      %{id: 12, code: "00117", title: "Programmer Senior"},
      %{id: 13, code: "00118", title: "Staff Admin"},
      %{id: 14, code: "00120", title: "Staff Marketing Analytics"},
      %{id: 15, code: "00119", title: "Staff QA"},
      %{id: 16, code: "00123", title: "Staff Management"},
    ] |> Enum.map(& Repo.Role.insert(&1))
    :ok
  rescue
    Ecto.ConstraintError -> {:error, :eexists}
  after
  ...
  def seed_highlights() do
    [
      %{id:  1, code: "lead", title: "Lead"},
      %{id:  2, code: "knowledge_keeper", title: "Knowledge Keeper"},
    ] |> Enum.map(& Repo.Highlight.insert(&1))
    :ok
  rescue
    Ecto.ConstraintError -> {:error, :eexists}
  after
